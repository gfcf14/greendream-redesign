...
$(function() {
  ...
  $('#prevbtn').hover(function() {
    if (!inTransition) $('#prevbtn').attr('src', '/old-media/buttons/active/prev.png');
  });
  $('#playpausebtn').hover(function() {
    if (!inTransition) {
      if (paused) $('#playpausebtn').attr('src', '/old-media/buttons/active/play.png');
      else $('#playpausebtn').attr('src', '/old-media/buttons/active/pause.png');
    }
  });
  $('#nextbtn').hover(function() {
    if (!inTransition) $('#nextbtn').attr('src', '/old-media/buttons/active/next.png');
  });
  $('#forcebtn').mouseout(function() {
    $('#forcebtn').attr('src', '/old-media/buttons/hover/forceplay.png');
  });

  //attaching onmouseout image changes to the playback buttons
  $('#prevbtn').mouseout(function() {
    if (!inTransition) $('#prevbtn').attr('src', '/old-media/buttons/prev.png');
  });
  $('#playpausebtn').mouseout(function() {
    if (!inTransition) {
      if (paused) $('#playpausebtn').attr('src', '/old-media/buttons/play.png');
      else $('#playpausebtn').attr('src', '/old-media/buttons/pause.png');
    }
  });
  $('#nextbtn').mouseout(function() {
    if (!inTransition) $('#nextbtn').attr('src', '/old-media/buttons/next.png');
  });
  $('#forcebtn').mouseout(function() {
    $('#forcebtn').attr('src', '/old-media/buttons/forceplay.png');
  });

  $('#forcebtn').click(function() {
    $('#forcebtn').attr('src', '/old-media/buttons/active/forceplay.png');
    forcePlay();
  });
...
export function toggleButton(type) {
  if (type == 'shuffle') {
    shuffle = !shuffle;
    if (shuffle) $('#upimgshuffle').attr('src', '/old-media/buttons/active/shuffle.png');
    else $('#upimgshuffle').attr('src', '/old-media/buttons/shuffle.png');
  }
  else if (type == 'repeat') {
    repeat = !repeat;
    if (repeat) $('#upimgrepeat').attr('src', '/old-media/buttons/active/repeat.png');
    else $('#upimgrepeat').attr('src', '/old-media/buttons/repeat.png');
  }
  else if (type == 'reshuffle') {
    reshuffle = !reshuffle;
    if (reshuffle) $('#upimgreshuffle').attr('src', '/old-media/buttons/active/reshuffle.png');
    else $('#upimgreshuffle').attr('src', '/old-media/buttons/reshuffle.png');
  }
}
...
function changePause(pstats) {
  ...
  if (inTransition) {
    if (paused) $('#playpausebtn').attr('src', '/old-media/buttons/disabled/play.png');
    else $('#playpausebtn').attr('src', '/old-media/buttons/disabled/pause.png');
  }
  else {
...
function togglePlayBack(pstats) {
  if (pstats) {
    $('#prevbtn').attr('src', '/old-media/buttons/disabled/prev.png');
    ...
    $('#nextbtn').attr('src', '/old-media/buttons/disabled/next.png');
    $('#nextbtn').attr('onclick', '');
    $('#nextbtn').css('cursor', '');
  }
  else {
    if ($('#prevbtn').is(':hover')) $('#prevbtn').attr('src', '/old-media/buttons/active/prev.png');
    else $('#prevbtn').attr('src', '/old-media/buttons/prev.png');
    ...
    if ($('#nextbtn').is(':hover')) $('#nextbtn').attr('src', '/old-media/buttons/active/next.png');
    else $('#nextbtn').attr('src', '/old-media/buttons/next.png');
...
export function changeCopyImage() {
  ...
  if (option == 'youtube') $('#upcopy').attr('src', '/old-media/animated/youtube.gif');
  else if (option == 'soundcloud') $('#upcopy').attr('src', '/old-media/animated/soundcloud.gif');
  else if (option == 'vimeo') $('#upcopy').attr('src', '/old-media/animated/vimeo.gif');
  else if (option == 'dailymotion') $('#upcopy').attr('src', '/old-media/animated/dailymotion.gif');
}
